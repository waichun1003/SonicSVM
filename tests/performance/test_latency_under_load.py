...
class TestLatencyUnderLoad:
    ...
    async def test_health_5_concurrent(self) -> None:
    ...
    async def test_health_10_concurrent(self) -> None:
    ...
    async def test_snapshot_error_rate(self) -> None:
    ...
    async def test_stats_bimodal(self) -> None:
...
class TestBurstMultiEndpoint:
    ...
    async def test_burst_markets(self) -> None:
    ...
    async def test_burst_stats(self) -> None:
    ...
    async def test_burst_snapshot_errors(self) -> None:
