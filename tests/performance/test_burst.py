...
class TestBurst:
    ...
    async def test_20_burst_100_percent(self, base_url: str) -> None:
    ...
    async def test_50_burst_95_percent(self, base_url: str) -> None:
    ...
    async def test_recovery_under_2s(self, base_url: str) -> None:
